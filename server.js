...
app.get('/course/:id', (req, res) => {
  ...
  // Route for handling course selection
app.post('/select-courses', (req, res) => {
    ...
    const values = selectedCourses.map(course => [userId, course]);
    ...
    connection.query(query, [values], (error, results) => {
        ...
        return res.status(200).json({ message: 'Courses selected successfully' });
    });
});
...
app.get('/selected-courses', (req, res) => {
    ...
    // Fetch selected courses for the user from the database
    const query = `
        SELECT courses.*
        FROM courses
    ...
    connection.query(query, [userId], (error, results) => {
        ...
        // Render the selected courses page with the retrieved courses
        res.render('selected-courses', { courses: results });
    });
});
